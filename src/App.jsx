...
function Hero() {
  return <section className="hero" id="top"><div className="shell hero-grid">
    <div className="hero-copy">
      ...
      <p className="hero-availability"><span aria-hidden="true" /> Seeking 2027 new-grad technical roles in New York City</p>
    </div>
